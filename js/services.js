...
(function () {
  ...
  function renderGrid(tabKey) {
    ...
    items.forEach((t) => {
      ...
      card.innerHTML = `
        ${t.imageUrl ? `<div class="service-card-img" style="cursor:zoom-in" title="Click to view brochure" onclick="window.openBrochure && window.openBrochure('${t.imageUrl}','${t.name} brochure')"><img src="${t.imageUrl}" alt="${t.name} brochure" loading="lazy" style="width:100%;border-radius:8px 8px 0 0;display:block;max-height:220px;object-fit:cover;pointer-events:none"></div>` : ""}
